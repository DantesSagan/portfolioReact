...
export default function Project() {
  ...
  return (
    ...
    <div className='bg-gradient-to-r from-white via-blue-400 to-blue-300 2xl:h-screen lg:h-full'>
      <NavBar />
      <main className='relative mx-auto max-w-screen-md mt-2 '>
        {' '}
        <section
        ...
        >
          <div className='grid grid-cols-2 gap-1 place-items-center'>
            <div className='text-3xl p-4 font-bold underline col-span-2'>
              Some projects
              <svg
            ...
            <div className='border-b-2 border-white p-8 2xl:p-2 hover:border-b-2 hover:border-blue-500 rounded-lg'>
              <a
                rel='noreferrer'
